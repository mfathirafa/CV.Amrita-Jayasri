            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6 md:mb-8">
              ...
              <div className="lg:col-span-5 flex flex-col gap-4 md:gap-5">
                ...
                <div className="flex items-center gap-2 md:gap-3">
                  ...
                  <button 
                    onClick={() => { setInitialExportFormat('pdf'); setIsExportModalOpen(true); }}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 md:py-3 bg-[#5452F6] text-white rounded-xl text-[10px] md:text-xs font-bold hover:bg-[#4341E3] transition-all shadow-md shadow-indigo-100"
                  >
                      ...
                      {processedData.map((item) => {
                        ...
                        return (
                          <tr key={`${item._type}-${item.id}`} className="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td className="py-4 md:py-5 px-4 md:px-8 text-right font-black text-gray-800 text-[10px] md:text-sm whitespace-nowrap">{formatRupiah(item.jumlah * parseFloat(isMasuk ? item.harga_beli : item.harga_jual))}</td>
                          </tr>
                        );
                      })}
                    </tbody>
