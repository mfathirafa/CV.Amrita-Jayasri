        ...
        <div className="flex-1 overflow-y-auto p-8 pb-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-8">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5">
              ...
              <div className="flex items-center gap-3">
                <button className="flex items-center justify-center gap-2 px-5 py-3 bg-white border border-gray-200 rounded-xl text-xs font-bold text-gray-700 hover:bg-gray-50 transition-colors whitespace-nowrap shadow-sm">
                  <FileSpreadsheet className="w-4 h-4" /> Ekspor Excel
                </button>
                <button className="flex items-center justify-center gap-2 px-5 py-3 bg-[#5452F6] text-white rounded-xl text-xs font-bold hover:bg-[#4341E3] transition-all shadow-md shadow-indigo-100 whitespace-nowrap">
