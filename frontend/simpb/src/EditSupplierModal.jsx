  ...
  return (
    <>
      <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in">
        ...
        <div className="bg-white rounded-[24px] w-[95%] max-w-[480px] max-h-[90vh] overflow-y-auto p-6 md:p-8 shadow-2xl relative animate-in zoom-in-95 scrollbar-hide text-left">
          ...
          <h2 className="text-lg md:text-xl font-bold text-gray-800">Edit Informasi Supplier</h2>
          <p className="text-[10px] md:text-xs text-gray-500 mt-1 mb-6 md:mb-8">Perbarui detail kemitraan untuk validasi inventaris.</p>
          ...
          <div className="flex items-start gap-2 text-[#5452F6] bg-indigo-50/50 p-3 rounded-lg border border-indigo-50">
            ...
            <p className="text-[9px] md:text-[10px] font-medium leading-relaxed">
              Perubahan pada data ini akan segera diperbarui di seluruh sistem audit internal.
            </p>
          </div>
