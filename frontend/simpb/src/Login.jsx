    ...
    <div className="min-h-screen flex flex-col justify-center items-center bg-[#F4F7FC] p-4 md:p-6 relative overflow-x-hidden text-left">
      ...
      <div className="bg-white rounded-[24px] md:rounded-[30px] shadow-xl w-full max-w-[95%] sm:max-w-[420px] p-6 md:p-10 z-10 border border-gray-100 transition-all duration-300">
        ...
        <div className="flex flex-col items-center mb-6 md:mb-10">
          <div className="w-12 h-12 md:w-16 md:h-16 bg-[#5452F6] rounded-2xl flex items-center justify-center mb-4 shadow-lg shadow-indigo-100 transform transition-transform hover:scale-105">
            <Archive className="text-white w-6 h-6 md:w-8 md:h-8" strokeWidth={2} />
          </div>
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="space-y-1.5 md:space-y-2">
            <div className="flex justify-between items-center px-1">
              ...
              <button type="button" className="text-[10px] md:text-xs font-extrabold text-[#5452F6] hover:text-[#3B39D1] transition-colors">Lupa Password?</button>
            </div>
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
